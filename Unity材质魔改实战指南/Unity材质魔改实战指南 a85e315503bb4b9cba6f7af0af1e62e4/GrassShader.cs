...
{   
    /// <summary>
    /// 原来那个baseshaderGUI写的一坨屎一样 什么surfaceinput的override 有个几把用 还不如我直接继承ShaderGUI
    /// </summary>
    ...
    {   
        ...
        public override void AssignNewShaderToMaterial(Material material, Shader oldShader, Shader newShader){
            ...
            Debug.Log($"Assign new shader to current material {material.name}, plesea reassign properties!");
        } 
